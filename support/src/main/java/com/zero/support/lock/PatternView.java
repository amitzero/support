...
public class PatternView extends ViewGroup
{
	...
	{
        final TypedArray a = getContext().obtainStyledAttributes(attrs, com.zero.support.R.styleable.PatternView, defStyleAttr, 0);

        nodeSrc = a.getDrawable(com.zero.support.R.styleable.PatternView_nodeSrc);
        nodeOnSrc = a.getDrawable(com.zero.support.R.styleable.PatternView_nodeOnSrc);
        int lineColor = Color.argb(0, 0, 0, 0);
        lineColor = a.getColor(com.zero.support.R.styleable.PatternView_lineColor, lineColor);
        float lineWidth = 20.0f;
        lineWidth = a.getDimension(com.zero.support.R.styleable.PatternView_lineWidth, lineWidth);
	...
	protected void onLayout(boolean changed, int left, int top, int right, int bottom) 
	{
        ...
        int nodePadding = (nodeWidth / 2) - 30;
        for (int n = 0; n < 9; n++) {
